...
class Fork(OneLegFork, TwoLegFork):
    # def __init__(self, name, fork_type):
    #     if fork_type == "one-leg":
    #         OneLegFork.__init__(self)
    #     elif fork_type == "two-leg":
    #         TwoLegFork.__init__(self)
    #     self.fork_type = fork_type
    #     print(f"Bicycle fork type: {self.fork_type}")

    # def display_info(self):
    #     if self.fork_type == "one-legged":
    #         self.fork_type()
    #     elif self.fork_type == "two-legged":
    #         self.fork_type()
